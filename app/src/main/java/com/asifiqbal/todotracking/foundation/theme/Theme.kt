package com.asifiqbal.todotracking.foundation.theme
...
fun Theme(
    ...
    LaunchedEffect(colors) {
        when (colors) {
            LightColorPalette -> activity.setTheme(R.style.Theme_ToDoTracking_Light)
            TwilightColorPalette -> activity.setTheme(R.style.Theme_ToDoTracking_Twilight)
            NightColorPalette -> activity.setTheme(R.style.Theme_ToDoTracking_Night)
            SunriseColorPalette -> activity.setTheme(R.style.Theme_ToDoTracking_Sunrise)
            AuroraColorPalette -> activity.setTheme(R.style.Theme_ToDoTracking_Aurora)
        }
    }
